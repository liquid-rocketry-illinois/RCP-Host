...
enum RCP_HostClass {
    ...
    HOST_CLASS_TESTING_READ = 0x80,
    HOST_CLASS_SOLENOID_WRITE = 0x01,
    HOST_CLASS_SOLENOID_READ = 0x81,
    HOST_CLASS_STEPPER_WRITE = 0x02,
    HOST_CLASS_STEPPER_READ = 0x82,
};
...
enum RCP_TargetClass {
    ...
    TARGET_CLASS_TRANSDUCER_DATA = 0x78,
    TARGET_CLASS_GPS_DATA = 0x7E,
    TARGET_CLASS_MAGNETOMETER_DATA = 0x79,
    TARGET_CLASS_AM_PRESSURE_DATA = 0x7D,
    TARGET_CLASS_AM_TEMPERATURE_DATA = 0x7C,
    TARGET_CLASS_ACCELERATION_DATA = 0x7B,
    TARGET_CLASS_GYRO_DATA = 0x7A,
